...
V_xy=VelocityProfile(XY,t,steps,'polynomial2order');
...
%%
% fig_links_mov=figure;
% plot(XarmX_all(:,1:3:end),YarmY_all(:,1:3:end),'Color','black');
% hold on;
% plot(XXX,YYY,'Color','green','LineWidth',3);
% axis equal;
%%
% fig=figure;
% hold on;
% plot(1:steps,q(1,:),'Color','red');
% plot(1:steps,q(2,:),'Color','blue');
%
% fig2=figure;
% hold on;
% plot(1:steps,q_dot(1,:),'Color','red');
% plot(1:steps,q_dot(2,:),'Color','blue');
